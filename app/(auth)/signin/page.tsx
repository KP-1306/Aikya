...
export default function SignInPage() {
  ...
  // Build redirect to /auth/callback on the SAME origin we requested from
    ...
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (error) setMessage(error.message);
          ...
          setMessage(
            "Check your email for the sign-in link. Open it in the SAME browser you used to request it."
          );
      } catch (err: any) {
  ...
  return (
    <main className="container max-w-md mx-auto py-10">
      ...
      <p className="mt-6 text-sm text-neutral-600">
        Don’t have an account? <a href="/auth/signup" className="underline">Create one</a>
      </p>
